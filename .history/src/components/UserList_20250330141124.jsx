    ...
    <div className="users-list-container flex flex-col items-center">
      ...
      <div className="users-grid grid lg:grid-cols-3 gap-4 md:grid-cols-2 sm:grid-cols-1">
        {currentUsers.map(user => (
          <div key={user.id} className="user-card min-w-2/4 lg:w-4 h-auto  bg-white rounded-lg shadow-lg m-5 flex flex-col items-center justify-center hover:scale-105 duration-300">
