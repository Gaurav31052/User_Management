    ...
    <div className="users-list-container flex flex-col items-center">
      ...
      <div className="users-grid ">
        {currentUsers.map(user => (
          <div key={user.id} className="user-card min-w-4/4 h-auto  bg-white rounded-lg shadow-lg m-5 flex flex-col items-center justify-center hover:scale-105 ">
            <div className="w-full bg-purple-400 flex justify-center p-5 rounded-b-2xl" ><img className="border-purple-400 border-2 rounded-full" src={user.avatar} alt="Avatar" /></div>
