...
const EditUser = () => {
  ...
  return (
    ...
    <div className="edit-user-container flex flex-col justify-center items-center bg-white py-4 rounded-lg shadow-2xl w-64 md:w-64 lg:w-96">
      ...
      <div className="flex justify-center items-center flex-col md:flex-row "><span>First_Name: </span> <input
        className="border-2 border-purple-300 rounded-full p-1 w-full bg-white m-1"
          ...
          required
        /></div>
        <div className="flex justify-center items-center flex-col md:flex-row "><span>Last_Name: </span> <input
        className="border-2 border-purple-300 rounded-full p-1 w-full bg-white m-1"
          type="text"
          name="last_name"
          ...
          required
        /></div>
        <div className="flex items-start justify-center  flex-col md:flex-row md:items "><span>Email: </span>
        <input
        className="border-2 border-purple-300 rounded-full p-1 w-full bg-white m-1"
          type="email"
          name="email"
