...
const UsersList = ({ onLogout }) => {
  ...
  return (
    ...
    <div className="flex justify-around items-center p-5">
      ...
      <input className="border-2 border-purple-300 rounded-full p-1 w-96 bg-white p-2"
        type="text"
    ...
    <div className="users-list-container flex flex-col items-center">
      ...
      <div className="users-grid grid grid-cols-3 gap-4 md:grid-cols-2 sm:grid-cols-1">
        {currentUsers.length === 0 && <p className="text-2xl font-bold text-purple-900">No users found</p>}
