    ...
    <div className="users-list-container flex flex-col items-center">
      ...
      <div className="users-grid ">
        {currentUsers.map(user => (
          <div key={user.id} className="user-card min-w-4/4 h-auto p-5 bg-white rounded-lg shadow-lg m-5 flex flex-col items-center justify-center from-bg-purple-900 to-bg-purple-200 ">
