    ...
    <div className="users-list-container flex flex-col items-center">
      ...
      <div className="users-grid">
        {currentUsers.map(user => (
          <div key={user.id} className="user-card min-w-4/4 h-auto p-5 bg-white rounded-lg shadow-lg m-5 flex-col items-center ">
            <div><img src={user.avatar} alt="Avatar" /></div>
            <div><h3 className="font-semibold">{user.first_name} {user.last_name}</h3></div>
            <div></div><p><span className="font-semibold">Email: </span>{user.email}</p></div>
